    ...
    public class SeedData {
        ...
        public async Task seedDbContext(string[] staffId, string[] studentId) {
            ...
            Packet[] packets = {
                ...
                new Packet(){name = "Drink1", canteen=canteens[0], city = canteens[0].city, exampleProductList = exampleList[2], price=15, typeOfMeal = exampleList[2].type, startPickup=DateTime.Now.AddDays(6), endPickup=DateTime.Now.AddDays(6).AddHours(2)},
